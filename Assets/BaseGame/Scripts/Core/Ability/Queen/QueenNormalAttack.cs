...
namespace Core
{
    ...
    //     public QueenNormalAttack(Hero owner, Projectile projectile, Transform spawnPosition) : base(owner)
    //     {
    ...
    //     {
    //         return new QueenNormalAttack(Owner, Projectile, SpawnPosition);
    //     }
    // }
}