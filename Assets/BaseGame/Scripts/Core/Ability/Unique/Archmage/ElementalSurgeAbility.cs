...
namespace Core
{
    // public class ElementalSurgeAbility : CooldownAbility
    // {
    ...
    //     
    //     public ElementalSurgeAbility(Hero owner, float cooldown, VisualEffect visualEffect) : base(owner, cooldown)
    //     {
    ...
    //     {
    //         return new ElementalSurgeAbility(Owner, Cooldown, VisualEffect);
    //     }
    // }
}