...
namespace Core
{
    // public class StarfallAbility : CooldownAbility
    // {
    ...
    //     public StarfallAbility(Hero owner, float cooldown) : base(owner, cooldown)
    //     {
    ...
    //     {
    //         return new StarfallAbility(Owner, Cooldown);
    //     }
    // }
}