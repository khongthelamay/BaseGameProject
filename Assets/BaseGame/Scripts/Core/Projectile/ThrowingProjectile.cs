...
namespace Core
{
    public class ThrowingProjectile : Projectile
    {
        ...
        private Hero OwnerHero { get; set; }
        ...
        {
            return Instantiate(this, hero.Transform.position, Quaternion.identity).Setup(hero, targetEnemy);
        }
        ...
        public override Projectile Setup(Hero hero, Enemy targetEnemy)
        {
            ...
            StartPosition = OwnerHero.Transform.position;
            CurrentPosition = StartPosition;
            AttackDamage = OwnerHero.HeroStatData.BaseAttackDamage;
        ...
        {
            ProjectileBehaviorGroup.StartBehavior(OwnerHero, TargetEnemy);
                               ...
                               .WithCancellation(this.GetCancellationTokenOnDestroy()))
            {
                ...
                ProjectileBehaviorGroup.EndBehavior(OwnerHero, TargetEnemy);
                SelfDespawn();
                break;
            }
        }
